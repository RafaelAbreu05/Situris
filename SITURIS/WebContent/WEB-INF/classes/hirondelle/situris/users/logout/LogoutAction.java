package hirondelle.situris.users.logout;
...
public final class LogoutAction extends ActionImpl {
  
  /** Constructor. */
  public LogoutAction(RequestParser aRequestParser){
  ...
  */
  ...
  private static final ResponsePage REDIRECT = new ResponsePage("../../Logout.jsp");
