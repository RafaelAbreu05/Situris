...
public final class PreferencesAction extends ActionTemplateShowAndApply {
  ...
  protected void validateUserInput() throws AppException {
    if( isLoggedIn()){
      try {
        ...
        fPreferences = builder.build(Preferences.class, userId, getLoggedInUserName(),  NAME, LOCALE);
      }
  ...
  private static final ResponsePage FORWARD = TemplatedPage.get("Preferences", "Preferences.jsp", PreferencesAction.class);
